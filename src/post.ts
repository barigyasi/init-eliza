...
const UPDATED_MAX_TWEET_LENGTH = 100; // set by init-eliza
...
Your response should not contain any questions. Brief, concise statements only. The total character count MUST be less than ${UPDATED_MAX_TWEET_LENGTH}. No emojis. Use \\n\\n (double spaces) between statements if there are multiple statements in your response.`;
